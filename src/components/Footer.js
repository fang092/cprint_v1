...
function Footer() {
  return (
   <section id="footer" className='flex flex-row mx-auto bg-cprintBlue w-full h-fit p-4 xs:w-full xs:flex-col xs:space-y-8 xs:divide-y xs:divide-dashed sm:w-full sm:flex-col sm:space-y-10 sm:divide-y sm:divide-dashed md:w-full md:flex-row md:divide-none lg:w-full lg:flex-row lg:divide-none'>
